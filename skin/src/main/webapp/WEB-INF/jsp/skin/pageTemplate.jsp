...
<c:url var="khnCssUrl" value="/skin/khn.css" />
<c:url var="khnJsUrl" value="/skin/scripts/khn.js" />
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${khnCssUrl}" />
		...
		<script type="text/javascript" src="${khnJsUrl}"></script>
		<decorator:head />
	</head>
	<body>
		<div id="doc3">
			...
			<div id="ft">
				<div class="regionInner">
					<div class="yui-gc">
						<%-- <div id="aboutProject" class="yui-u first">
							<h2 style="margin-top:0">About<c:out value="${initParam.project}" /></h2>
							<div><c:out value="${initParam.aboutThisproject}" escapeXml="false" /></div>
						</div>  --%>
						<%-- <div id="projectLinks" class="yui-u">
							<div>
							</div>
						</div> --%>
					</div>
